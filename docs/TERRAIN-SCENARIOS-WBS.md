...
| TS-3 | Evidence and downstream guidance | Root | Pending | Children accepted |
...
| TS-3.2 | Canonical Vercel release and durable capture | Root | Pending | Exact application commit passes CI/build and live browser; release evidence and memory updated |
