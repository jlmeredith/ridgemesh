...
**Status:** Accepted and deployed at ridgemesh.vercel.app; evidence and external-data limits recorded.
...
| PC-4 | Remote acceptance and replacement release | Root | Accepted | Child packages accepted |
...
| PC-4.3 | Vercel preview, production smoke and durable handoff | Root | Accepted | Clean CI/build, exact deployed revision and browser run retained; source/remaining-data limits and rollback captured in repo + Codex memory |
...
Final production: application `2ddbc862b48415a3f2d98900bd73810f2b552436`, deployment `dpl_3FLar7MJBGq6yb3dEjCq4kNkkzBJ`; [14-check canonical production report with completed imagery loads](evidence/planner-production-2ddbc86-verified-browser-report.json), run `planner-production-2ddbc86-verified-20260913` on z370.43 tests and clean hosted CI passed; source/field limitations remain explicit in the release record.
