...
**Status:** Complete; deployed and verified on the canonical Vercel site.
...
| OS-3 | Remote verification and replacement deployment | Root | Accepted | Child packages accepted |
...
| OS-3.2 | Vercel production and durable record | Root | Accepted | Exact revision deployed and canonical browser verified, evidence committed, Codex/Graphiti public-reference capture updated |

Primary evidence: [release record](OPTIMIZED-START-RELEASE-2026-09-13.md), z370 runs `optimized-start-integration-20260913` (47 tests) and `optimized-start-release-20260913` (type/lint/build and 22 browser checks). OS-3.2 accepted: production `dpl_DKjWpzqfzoRWuwW83iFzRH8C376g`, application `0de9e361eead4a6beef938fa11e18e3d6e18a2c2`, hosted CI `34731403631` and `34731405092`, canonical z370 run `optimized-start-production-0de9e36-20260913` (22 checks, zero errors/failed requests).
